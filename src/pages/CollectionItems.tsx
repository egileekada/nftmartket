            ...
            <div className=' w-full flex flex-col my-10 items-center ' >
                <div className=' xl:w-1360px w-full flex items-center ' >
                    <div className='flex mx-8 items-center font-NotoSans-Bold' >
                        <button onClick={()=> setTab(false)} className={!tab ? ' border-b-4 pb-2 border-[#31CF99] w-24 text-[#4D0E7D] ' : ' border-b-4 text-[#707070] border-transparent w-24'} >
                            <p>Items</p>
                        </button>
                    </div>
                    <div className='flex mx-8 items-center font-NotoSans-Bold' >
                        <button onClick={()=> setTab(true)} className={tab ? ' border-b-4 pb-2 border-[#31CF99] w-24 text-[#4D0E7D] ' : ' border-b-4 text-[#707070] border-transparent w-24'} >
                            <p>Activity</p>
                        </button>
                    </div>
                </div>
